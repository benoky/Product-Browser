...
public class BasketRowModel {
    ...
    public BasketRowModel(int index,String site, String name, String price,String rating,String detailUrl,String shippingCharge,String imageUrl,ImageView imageView) {
